...
Random Forest Regression metrics: MAE: 2956.7923371477714 RMSE: 5056.020242853598 R2: 0.8225083593592852

Ytest values: {rSq: 0.8225083593592852,  sst: 154251421569.71732,  sse: 27378337885.571674,  mse: 25563340.696145356,  rmse: 5056.020242853598,  mae: 2956.7923371477714,  m: 1071}
...
\section{Insurance Annual Medical Cost}
...
Alternative approaches (including Ridge and Lasso regression, second-order polynomials, square root transformations, and neural networks) were evaluated but yielded poor predictive performance (CV $R^2 < 0.1$). This underperformance likely stems from the weak correlation between the predictors and the target variable, Annual Medical Cost. Furthermore, the target distribution is heavily skewed, with most values concentrated below $\$2,000$. Unlike the other regression models tested, Random Forest effectively managed this skewed distribution to provide more reliable results.
