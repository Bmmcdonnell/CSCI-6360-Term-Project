...
\begin{itemize}
	...
	\item \textbf{Insurance Annual Premium:} This dataset contains information about different primary beneficiaries of health insurance. The goal is to predict the primary beneficiaries annual premium given their other characteristics. The dataset can be found at \url{https://www.kaggle.com/datasets/mohankrishnathalla/medical-insurance-cost-prediction}.
\end{itemize}
...
\section{Insurance Annual Premium}

\subsection{Exploratory Data Analysis}

The Insurance Annual Premium dataset contains $100,000$ observations each having $54$ variables. Some of the variables are:
\begin{itemize}
	\item age: The age of the primary beneficiary.
	\item sex: The insurance contractor sex: female or male.
	\item bmi: The body mass index of the primary beneficiary.
	...
	\item annual\_premium: (The target variable) Individual medical costs billed by health insurance.
\end{itemize}

The Insurance Annual Premium dataset contains 30,083 missing values, so we remove these rows. For modeling purposes, we converted all the categorical variables into dummy variables.

Univariate distributions are visualized in \Cref{fig:Insurance Annual Premium Histograms} (histograms/count-plots) and \Cref{fig:Insurance Annual Premium Box Plots} (box plots for continuous variables).
...
\begin{figure}[H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.75\textwidth]{../Insurance_Annual_Premium/histograms.png} 
    \caption{Insurance Annual Premium Histograms and Count-Plots}
    \label{fig:Insurance Annual Premium Histograms}
\end{figure}

\begin{figure}[H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.75\textwidth]{../Insurance_Annual_Premium/boxplots.png} 
    \caption{Insurance Annual Premium Box Plots}
    \label{fig:Insurance Annual Premium Box Plots}
\end{figure}

\Cref{fig:Insurance Annual Premium Scatterplots} displays the bivariate relationships between some of the predictors and the target variable, Annual Premium, while the corresponding correlation matrix is provided in \Cref{fig:Insurance Annual Premium Correlation Heat Map}.
...
\begin{figure}[H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.75\textwidth]{../Insurance_Annual_Premium/scatterplots.png} 
    \caption{Insurance Annual Premium Scatterplots}
    \label{fig:Insurance Annual Premium Scatterplots}
\end{figure}

\begin{figure}[H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.5\textwidth]{../Insurance_Annual_Premium/correlation_heatmap.png} 
    \caption{Insurance Annual Premium Correlation Heat Map}
    \label{fig:Insurance Annual Premium Correlation Heat Map}
\end{figure}

\Cref{fig:Insurance Annual Premium Hue Plots} illustrates the bivariate relationships among some of the predictor variables, with data points colored by the target variable, Annual Premium.
...
\begin{figure}[H]
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.9\textwidth]{../Insurance_Annual_Premium/Hue_Plots.png} 
    \caption{Insurance Annual Premium Hue Plots}
    \label{fig:Insurance Annual Premium Hue Plots}
\end{figure}
